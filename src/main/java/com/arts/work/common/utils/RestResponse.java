...
public class RestResponse<T> implements Serializable {
     ...
     */
    public RestResponse(int code, T data, String message, String description) {
        this.code = code;
        this.data = data;
    ...
    public RestResponse(ErrorCode errorCode) {
        this(errorCode.getCode(), null, errorCode.getMessage(), errorCode.getDescription());
    }

    public RestResponse(ErrorCode errorCode, String description) {
